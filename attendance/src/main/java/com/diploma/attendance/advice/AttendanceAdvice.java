...
public class AttendanceAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({EntityNotFoundException.class, 
                       com.diploma.attendance.exception.AttendanceNotFoundException.class,
                       com.diploma.attendance.exception.AttendanceTypeNotFoundException.class})
